...
const int fingerings[NUM_FINGERINGS][17] = {
  ...
  {0,  1, 2, 1, 1,  2, 2, 2, 2,  1, 1, 2, 1,  2, 2, 1,  51}, // Eb
  {0,  1, 2, 1, 1,  2, 1, 2, 2,  1, 1, 2, 1,  2, 2, 2,  51}, // Eb
  {0,  1, 2, 1, 1,  2, 2, 2, 2,  1, 1, 0, 0,  2, 2, 2,  52}, // E
  {0,  1, 2, 1, 1,  2, 2, 2, 2,  1, 1, 1, 0,  2, 2, 2,  53}, // F
  {0,  1, 2, 1, 1,  2, 2, 2, 2,  1, 0, 2, 1,  2, 2, 2,  53}, // F
  {0,  1, 2, 1, 1,  2, 2, 2, 2,  1, 0, 2, 0,  2, 2, 2,  54}, // F#

  {0,  1, 2, 1, 1,  0, 2, 2, 2,  0, 0, 2, 0,  2, 2, 2,  55}, // G
  {0,  1, 2, 1, 1,  1, 2, 2, 2,  0, 0, 2, 0,  2, 2, 2,  56}, // Ab
  {0,  1, 2, 1, 0,  2, 2, 2, 2,  0, 0, 2, 0,  2, 2, 2,  57}, // A
  {0,  1, 2, 1, 0,  2, 2, 2, 2,  1, 0, 2, 0,  2, 2, 2,  58}, // Bb
  {0,  1, 2, 0, 0,  2, 2, 2, 2,  0, 0, 2, 0,  2, 2, 2,  59}, // B
  {0,  1, 2, 0, 0,  2, 2, 2, 2,  1, 0, 2, 0,  2, 2, 2,  60}, // C

  {0,  0, 1, 1, 1,  2, 2, 2, 2,  1, 1, 2, 1,  2, 1, 2,  61}, // C#
  {0,  0, 1, 1, 1,  2, 0, 2, 2,  1, 1, 2, 1,  2, 2, 0,  62}, // D
  {0,  0, 1, 1, 1,  2, 0, 2, 2,  1, 1, 2, 1,  2, 2, 1,  63}, // Eb
  {0,  0, 1, 1, 1,  2, 1, 2, 2,  1, 1, 2, 1,  2, 2, 2,  63}, // Eb

  {1,  1, 2, 1, 1,  2, 2, 2, 2,  1, 1, 0, 0,  2, 2, 2,  64}, // E
  {1,  1, 2, 1, 1,  2, 2, 2, 2,  1, 1, 1, 0,  2, 2, 2,  65}, // F
  {1,  1, 2, 1, 1,  2, 2, 2, 2,  1, 0, 2, 1,  2, 2, 2,  65}, // F
  {1,  1, 2, 1, 1,  2, 2, 2, 2,  1, 0, 2, 0,  2, 2, 2,  66}, // F#

  {1,  1, 2, 1, 1,  0, 2, 2, 2,  0, 0, 2, 0,  2, 2, 2,  67}, // G
  {1,  1, 2, 1, 1,  1, 2, 2, 2,  0, 0, 2, 0,  2, 2, 2,  68}, // Ab
  {1,  1, 2, 1, 0,  2, 2, 2, 2,  0, 0, 2, 0,  2, 2, 2,  69}, // A
  {1,  1, 2, 1, 0,  2, 2, 2, 2,  1, 0, 2, 0,  2, 2, 2,  70}, // Bb
  {1,  1, 2, 0, 0,  2, 2, 2, 2,  0, 0, 2, 0,  2, 2, 2,  71}, // B
  {1,  1, 2, 0, 0,  2, 2, 2, 2,  1, 0, 2, 0,  2, 2, 2,  72}, // C
